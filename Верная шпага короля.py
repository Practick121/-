...
navik = otvet
if navik == "1":
    print("Чтобы ударить противника секретным ударом, напишите 1 во время боя и удар нанесет 4 урона")
elif navik == "2":
    print("Если во время боя у вас выпадет четное число, то вы нанесете противнику дополнительно 1 урон")
elif navik == "3":
    print("Вместо 4 урона вы будете наносить 8, и если захотите испытать свою удачу после выстрела и вам повезет, то вы убьете сразу 2 противников.")
elif navik == "4":
...
но действовать во время боя этой рукой вы уже не сможете. А бой неизбежен — всадники совсем рядом. На ответный выстрел времени не остается.
Вы выхватываете шпагу и готовитесь к обороне. Если вы не владеете искусством боя левой рукой, то пока правая не заживет (еще 2 дня), у вас будет уменьшаться
2 единицы ЛОВКОСТИ каждый бой.''', -3)
    prryka = False
    input("(Нажми ENTER)")
    p217()
